...
const AnimatedPaths = ({ pie, animated, setAnimated }) => {
    ...
    useEffect(() => {        
        if (loaded && activeMonthProgress.length > 0) {
            ...
            console.log("first use effect at the top animated:  ", animated)
            console.log("fist use effect at the top animatation ran:  ", animationRan)
            ...
            paths.forEach((path, index) => {
                ...
                console.log("second use effect at the top animated:  ", animated)
                console.log("second use effect at the top animatation ran:  ", animationRan)
                console.log(paths[12].dataset)
               ...
               debugger
                ...
                console.log(paths[12].dataset)
                paths.forEach((path) => {
                    path.dataset.status = getStatus(path.dataset.day, path.dataset.name)
                    })
                }
        ...
        //     console.log("second use effect animated:  ", animated)
        //     console.log("second use effect animatation ran:  ", animationRan)
    ...
    const paths = !loaded? null : pie.map((slice, index) => {
        ...
        return <>
            ...
            <path className="habbitOne" data-day={index} data-status={animationRan ?  "incomplete" : habitNames[0]  ? `${getStatus(index, habitNames[0])}` : null} data-name={habitNames[0]} id={`day${index.toString()}habit1`} key={`day${index.toString()}habit1`}  d={habitNames[0] ? arc(slice) : null} stroke={'black'} fill={"#FFFFFF"} data-color={"#e76f51"} onClick={(e)=> habitRingClick(e)}/>
            <path className="habbitTwo" data-day={index} data-status={animationRan  ? "incomplete" : habitNames[1] ? `${getStatus(index, habitNames[1])}` : null} data-name={habitNames[1]} id={`day${index.toString()}habit2`} key={`day${index.toString()}habit2`} d={habitNames[1] ? arc2(slice) : null} stroke={'black'} fill={'#FFFFFF'} data-color={"#e76f51"} onClick={(e)=> habitRingClick(e)}/>
            <path className="habbitThree" data-day={index} data-status={animationRan ? "incomplete" : habitNames[2] ? `${getStatus(index, habitNames[2])}` : null}  data-name={habitNames[2]} id={`day${index.toString()}habit3`} key={`day${index.toString()}habit3`}  d={habitNames[2] ? arc3(slice) : null} stroke={'black'} fill={'#FFFFFF'} data-color={"#e76f51"} onClick={(e)=> habitRingClick(e)} />     
             <path className="habbitFour" data-day={index} data-status={animationRan ?  "incomplete" : habitNames[3] ? `${getStatus(index, habitNames[3])}` : null}  data-name={habitNames[3]} id={`day${index.toString()}habit4`} key={`day${index.toString()}habit4`}   d={habitNames[3] ? arc4(slice) : null} stroke={'black'} fill={'#FFFFFF'} data-color={"#e76f51"} onClick={(e)=> habitRingClick(e)}  />       
             <path className="habbitFive" data-day={index} data-status={animationRan ? "incomplete" : habitNames[4] ? `${getStatus(index, habitNames[4])}` : null}  data-name={habitNames[4]} id={`day${index.toString()}habit5`} key={`day${index.toString()}habit5`} d={habitNames[4] ? arc5(slice) : null} stroke={'black'} fill={'#FFFFFF'} data-color={"#e76f51"}  onClick={(e)=> habitRingClick(e)} />
             <path className="habitSix" data-day={index} data-status={animationRan ? "incomplete" : habitNames[5] ? `${getStatus(index, habitNames[5])}` : null}  data-name={habitNames[5]} id={`day${index.toString()}habit6`} key={`day${index.toString()}habit6`} d={habitNames[5] ? arc6(slice) : null} stroke={'black'} fill={'#FFFFFF'} data-color={"#e76f51"} onClick={(e)=> habitRingClick(e)} />
             <path className= "habitSeven" data-day={index} data-status={"incomplete"}  data-name={habitNames[6]} id={`day${index.toString()}habit7`} key={`day${index.toString()}habit7`} d={habitNames[6]? arc7(slice) : null} stroke={'black'} fill={'#FFFFFF'} data-color={"#e76f51"} onClick={(e)=> habitRingClick(e)} />
